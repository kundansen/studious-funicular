...
Rigorous important work, that nobody outside of academic conferences cared about, because these agents couldn't book a restaurant reservation, let alone threaten anyone's job. The word "agent" in computer science lived a quiet, respectable, peer-reviewed life.

That changed once we entered the GenAI era.
...
The thing that made the word explode was a combination of marketing and a pile-up of multiple factors. First, LLMs made natural language instructions *feel* like intent, and intent is the psychological doorway into calling something an agent. When you type "book me a flight to Denver" and the system actually starts browsing airline sites, the leap from "tool" to "agent" happens naturally and intuitively in your head.
...
Third, and most cynically, autonomy became a pricing narrative. Why sell tokens when you can sell outcomes? Why charge per seat when your "agent" replaces the person who sat in it? The shift from "copilot" to "agent" was a combination of technical and ROI work. The word was doing revenue work.

Within 18 months, "agentic" went from an Andrew Ng conference talk to a mandatory keyword on every enterprise pitch deck in existence. I think that's when the trouble started.
...
Most of what's called "agentic" today lives somewhere between a dressed-up chatbot and an unsupervised intern with administrator access. Marketing says autonomous digital workers have arrived; engineering says "it works great in the demo."
...
Keep the word if you want, just don't outsource your judgment to it. Next time someone tells you their product is "agentic," ask three questions:

***What permissions does it have?***

***What can it change?***

***Who gets paged at 2 AM when it breaks?***
